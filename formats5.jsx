    ...
    items: [
      {
        ...
        p: "Klare Aufgabe, klares Ergebnis. Marken- und Kommunikationsstrategie: Positionierung, Konzept, Roadmap – und die Führung der Gewerke, bis das Ergebnis steht. Sechs bis sechzehn Wochen, je nach Aufgabe. Für Übergänge auch auf Zeit im Haus.",
      },
      {
        wm: "sparring",
        script: "sparring",
      ...
      },
      {
        ...
        p: "Kleinere Vorhaben entstehen direkt: Strategie, Konzept und Gestaltung in einer Hand, beschleunigt durch KI-gestützte Prozesse. Für mittelständische Aufgaben – etwa die Marke eines Architekturbüros – heißt das Positionierung bis fertiges Ergebnis, ohne Reibungsverlust. Wird es größer oder komplexer, führt das Netzwerk die Umsetzung.",
      },
    ],
  },
  en: {
    ...
    items: [
      {
        ...
        p: "Clear task, clear result. Brand and communication strategy: positioning, concept, roadmap – and the direction of the disciplines until the result stands. Six to sixteen weeks, depending on the task. For transitions, also on-site for a time.",
      },
      {
        wm: "sparring",
        script: "sparring",
