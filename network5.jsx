...
const NETWORK5 = {
  de: {
    label: "Netzwerk",
    title: "die umsetzung.",
    intro: "Kein Apparat – aber auch kein Alleingang. Die Umsetzung führen Partner, mit denen seit Jahren, teils Jahrzehnten, echte Projekte entstanden sind. In jedem dieser Felder eigene Praxis: Das macht Auswahl belastbar, Briefings präzise und das Qualitätsurteil unabhängig. Konzept, Auswahl und Qualität liegen an einer Stelle.",
